...
if "df" in st.session_state:
    ...
    st.subheader("streamlit: Sentiment Score by Product")
    grouped = st.session_state["df"].groupby(["PRODUCT"])["SENTIMENT_SCORE"].mean()
    st.bar_chart(grouped)

    st.subheader(f"matplotlib: Sentiment Score Distribution for {product}")
    ...
    st.subheader(f"plotly: Sentiment Score Distribution for {product}")
    ...
    st.subheader(f"altair: Sentiment Score Distribution for {product}")
